                    ...
                    foreach ($this->getJanusParameters($row) as $index => $parameter) {
                        ...
                        $action = $this->upsertSubstanceDataRow(
                            ...
                            [
                                ...
                                'value_assessment_index' => $parameter['value'],
    ...
    private function getJanusParameters(object $row): array
    {
        return [
            [
                'name' => 'Persistency',
                'specific_name' => 'P',
                'value' => $this->toNullableFloat($row->p_assessment_index),
            ...
            [
                ...
                'specific_name' => 'B',
                'value' => $this->toNullableFloat($row->b_assessment_log_units),
            ...
            [
                'name' => 'Toxicity',
                'specific_name' => 'T',
                'value' => $this->toNullableFloat($row->t_assessment_mg_l),
            ...
            [
                ...
                'specific_name' => 'ED',
                'value' => $this->toNullableFloat($row->ed_assessment_index),
