...
class EmpodatSuspectSedimentXlsxStationsMappingFillSeeder extends Seeder
{
     ...
     * with empodat_stations.short_sample_code for SEDIMENT data (CONNECT pattern)
     */
    public function run(): void
    {
        $this->command->info('Filling empodat_suspect_xlsx_stations_mapping for SEDIMENT data (CONNECT pattern)...');
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectSedimentXlsxStationsMappingFillSeeder
