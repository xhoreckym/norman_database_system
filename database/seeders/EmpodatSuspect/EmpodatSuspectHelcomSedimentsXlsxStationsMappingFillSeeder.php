...
class EmpodatSuspectHelcomSedimentsXlsxStationsMappingFillSeeder extends Seeder
{
     ...
     * with empodat_stations.short_sample_code for HELCOM PreEMPT SEDIMENTS data
     */
    public function run(): void
    {
        $this->command->info('Filling empodat_suspect_xlsx_stations_mapping for HELCOM PreEMPT SEDIMENTS data...');
...
FROM (
    ...
    WHERE
        ...
        AND LOWER(m.xlsx_name) LIKE '%sediment%'
    GROUP BY
        m.id
) AS subquery
...
// php artisan db:seed --class=Database\\Seeders\\EmpodatSuspect\\EmpodatSuspectHelcomSedimentsXlsxStationsMappingFillSeeder
