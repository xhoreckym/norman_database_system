                ...
                ->each(function ($rows, $key) use ($targetTable, $now, $path, $startTime): void {
                    ...
                    foreach ($rows as $row) {
                        ...
                        $records[] = [
                            ...
                            'p_assessment_class' => $this->nullableString($this->rowValue($row, ['P assessment [class]', 'p_assessment_class'])),
                            'p_assessment_index' => $this->nullableFloat($this->rowValue($row, ['P assessment [index]', 'p_assessment_index'])),
                            ...
                            'b_assessment_log_units' => $this->nullableFloat($this->rowValue($row, ['B assessment [log units]', 'b_assessment_log_units'])),
                            ...
                            't_assessment_mg_l' => $this->nullableFloat($this->rowValue($row, ['T assessment [mg/l]', 't_assessment_mg_l'])),
                            ...
                            'ed_assessment_class' => $this->nullableString($this->rowValue($row, ['ED assessment [class]', 'ed_assessment_class'])),
                            'ed_assessment_index' => $this->nullableFloat($this->rowValue($row, ['ED assessment [index]', 'ed_assessment_index'])),
                            ...
                            'score_vpvb' => $this->nullableFloat($this->rowValue($row, ['SCORE(vPvB)', 'score_vpvb'])),
                            'score_svhc' => $this->nullableFloat($this->rowValue($row, ['SCORE(SVHC)', 'score_svhc'])),
                            'score_pbt' => $this->nullableFloat($this->rowValue($row, ['SCORE(PBT)', 'score_pbt'])),
