      ...
      <div class="bg-white shadow-lg sm:rounded-lg" >
        <div class="p-6 text-gray-900">
          ...
          <div class="flex items-center space-x-4 mb-4">
            @auth
              <a href="{{ route('prioritisation.modelling-scarce.csv') }}" class="btn-download">
              ...
              <tr class="@if($loop->odd) bg-slate-100 @else bg-slate-200 @endif ">
                <td class="p-1 text-center">
                  <div class="flex items-center justify-center space-x-2">
                    <a href="{{ route('prioritisation.modelling-scarce.show', $e->id) }}"
                       target="_blank"
                       class="text-teal-600 hover:text-teal-800 transition-colors"
                       title="View full record details">
                      <i class="fas fa-search"></i>
                    </a>
                    <a href="{{ route('prioritisation.modelling-scarce.show', $e->id) }}" target="_blank" class="font-mono text-teal-800 hover:text-teal-600 hover:underline">
