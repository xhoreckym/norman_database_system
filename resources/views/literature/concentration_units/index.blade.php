        ...
        <div class="p-6 text-gray-900">
          ...
          <div class="mb-6 flex justify-between items-center">
            ...
            <div class="flex space-x-3">
              <a href="{{ route('literature.concentration_units.download') }}" class="btn-submit">
                Download CSV
              </a>
              ...
              <tbody>
                @forelse ($concentrationUnits as $index => $concentrationUnit)
                  <tr class="hover:bg-slate-300 transition {{ $index % 2 === 0 ? 'bg-slate-100' : 'bg-slate-200' }}">
                    <td class="py-2 px-4">
                      <span class="font-mono text-xs font-semibold text-gray-800">{{ $concentrationUnit->id }}</span>
                    </td>
                    <td class="py-2 px-4">
