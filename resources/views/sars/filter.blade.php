  ...
  <div class="py-4">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg rounded-0">
        ...
        <form  name="searchSars" id="searchSars" action="{{route('sars.search.search')}}" method="GET">
              ...
              <div class="bg-gray-100 p-2">
                ...
                {{-- <div class="flex"> --}}
                  <div class="w-full">
                    ...
                    @include('_t.form-apline-multiselect', [
                    'tag' => 'laboratorySearch', 'list' => $laboratoryList,
                    'active_ids' => isset($request->laboratorySearch) ? $request->laboratorySearch : [],
                    ])
                  </div>
