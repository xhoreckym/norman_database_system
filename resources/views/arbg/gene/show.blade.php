      ...
      <div class="bg-white shadow-lg sm:rounded-lg">
        <div class="p-6 text-gray-900">
          ...
          <div class="mb-6 bg-white border border-gray-200 rounded-lg p-6 shadow-sm">
            <h2 class="text-lg font-semibold text-gray-900 mb-4">ARBG Gene Record at Glance</h2>
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
              ...
              @if ($record->gene_name)
                <div>
                  <h3 class="text-sm font-medium text-gray-800 mb-1">Gene Name</h3>
                  <p class="text-sm text-teal-800 font-mono">{{ $record->gene_name }}</p>
                </div>
              @endif
              @if ($record->gene_description)
                <div>
                  <h3 class="text-sm font-medium text-gray-800 mb-1">Gene Description</h3>
                  <p class="text-sm text-teal-800 font-mono">{{ $record->gene_description }}</p>
                </div>
              @endif
              @if ($record->gene_family)
                <div>
                  <h3 class="text-sm font-medium text-gray-800 mb-1">Gene Family</h3>
                  <p class="text-sm text-teal-800 font-mono">{{ $record->gene_family }}</p>
                </div>
              @endif
