...
@section('page-subtitle', 'Number of gene records per sample matrix')
...
@section('main-content')
  ...
  @if(isset($message))
    ...
    <div class="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mb-6">
      ...
      <a href="{{ route('arbg.gene.statistics.index') }}" class="text-blue-600 hover:text-blue-800 underline text-sm">
