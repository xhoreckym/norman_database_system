  ...
  <div class="py-4">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg rounded-0">
        ...
        <form x-data="{
        ...
        }" @submit="submitForm($event)" name="searchEcotox" id="searchEcotox"
          action="{{ route('ecotox.credevaluation.search.search') }}" method="GET">
          ...
          <div class="p-4 text-gray-900 grid grid-cols-1 gap-4">
            ...
            <div class="flex justify-end m-2">
              <a href="{{ route('ecotox.credevaluation.search.filter') }}" class="btn-clear mx-2"> Reset </a>
