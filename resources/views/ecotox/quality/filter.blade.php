<x-app-layout>
  ...
  <div class="py-4">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg rounded-0">
        ...
        name="searchEcotoxQuality" 
        id="searchEcotoxQuality" 
        action="{{route('ecotox.quality.search.search')}}" 
        method="GET">
        ...
        <div class="text-center p-8 bg-white rounded-lg shadow-xl max-w-md w-full">
          ...
          <h2 class="text-xl font-bold text-slate-700 mb-2">ECOTOX Quality Search</h2>
          ...
          <p class="text-gray-600 mt-2">Searching the quality database with your criteria...</p>
    ...
    <div class="p-4 text-gray-900 grid grid-cols-1 gap-4">
      ...
      <div id="searchSubstance">
        <div class="bg-gray-100 p-2">
          ...
          <div>
            @livewire('App\Livewire\Ecotox\QualitySubstanceSearch', ['existingSubstances' => $request->substances])
          </div>
        </div>
      </div>
      ...
      <div class="flex justify-end m-2">
        <a href="{{route('ecotox.quality.search.filter')}}" class="btn-clear mx-2"> Reset </a>
  ...
  <div class="m-2">
    <ul class="list-disc list-inside text-gray-700 text-sm">
      <li>All search criteria are optional. If you do not select any criteria, all quality data will be displayed.</li>
