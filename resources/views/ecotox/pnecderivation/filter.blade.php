  ...
  <div class="py-4">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg rounded-0">
        ...
        <form x-data="{
        ...
        }" @submit="submitForm($event)" name="searchPnecDerivation" id="searchPnecDerivation"
          action="{{ route('ecotox.pnecderivation.search.search') }}" method="GET">
          ...
          <div x-show="loading"
            ...
            <div class="text-center p-8 bg-white rounded-lg shadow-xl max-w-md w-full">
              ...
              <h2 class="text-xl font-bold text-slate-700 mb-2">PNEC Derivation Search</h2>

              <svg class="mx-auto animate-spin h-20 w-20 text-slate-500 my-6" xmlns="http://www.w3.org/2000/svg"
          ...
          <div class="p-4 text-gray-900 grid grid-cols-1 gap-4">
            ...
            <div class="flex justify-end m-2">
              <a href="{{ route('ecotox.pnecderivation.search.filter') }}" class="btn-clear mx-2"> Reset </a>
            ...
            <div class="m-2">
              <ul class="list-disc list-inside text-gray-700 text-sm">
                <li>All search criteria are optional. If you do not select any criteria, all data will be displayed.
                </li>
                <li>Each time the search is executed, the search options are recorded in the database for future
                  reference and performance improvements.</li>
                <li>We encourage users to register for a free account to save-&-view their search criteria and results.
                </li>
              </ul>
            </div>
