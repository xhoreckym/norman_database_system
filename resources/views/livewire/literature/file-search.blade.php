<div>
  ...
  <input
    ...
    wire:focus="setFocus"
    wire:blur="removeFocus"
    name="searchFileString"
    id="searchFileString"
    placeholder="Search files by name (Literature module only)..."
  ...
  <!-- Search Results -->
  <div class="mt-2" wire:mousedown="keepFocus">
    @if($resultsAvailable)
      @if($results->count() > 0)
      ...
      @else
        <div class="text-sm text-red-600 mt-2">No files found for the Literature module</div>
      @endif
    @endif
  </div>
</div>
