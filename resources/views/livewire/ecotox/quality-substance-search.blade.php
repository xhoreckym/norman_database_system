<div>
    <div id="searchResults" class="mb-4">
                    ...
                    <div class="flex items-center px-4 py-2 rounded-lg bg-lime-50 border border-lime-200 shadow-sm group hover:bg-lime-100 transition duration-150 ease-in-out">
                        ...
                        @if(isset($substance['ecotox_record_count']))
                            <div class="ml-3 flex items-center gap-1 px-2 py-1 rounded-full bg-lime-200 text-lime-800">
                                ...
                                <span class="text-xs font-medium">{{ $substance['ecotox_record_count'] }} quality records</span>
                            </div>
                        @endif
        ...
        <input type="text" wire:model.live.debounce.300ms="search" name="searchSubstanceString" id="searchSubstanceString" class="w-full px-4 py-2 border border-gray-300 shadow-sm focus:outline-none focus:ring-2 focus:ring-lime-500 focus:border-transparent transition duration-200 ease-in-out" placeholder="Search for substances with quality data...">
        <div class="mt-4">
        ...
        <div class="flex flex-col md:flex-row justify-between text-sm text-gray-600 mt-2">
            <span>The search is limited to 30 substances with quality data</span>
        ...
        <div>
            ...
            <div class="mt-2 p-2 bg-lime-50 border-l-4 border-lime-500 text-lime-800 text-sm">
                <p>Select a substance and click <span class="font-semibold">Select & Search</span> to view its quality data.</p>
            </div>
            @endif
            ...
            <div class="max-h-64 overflow-y-auto mt-2 border border-gray-200 rounded-md">
                ...
                <div class="block p-2 hover:bg-gray-50 border-b border-gray-100 last:border-b-0">
                    <label class="flex items-center cursor-pointer">
                        ...
                        <span class="ml-2 bg-green-100 px-2 py-1 rounded-full text-xs font-medium">{{ $result->ecotox_record_count }} quality records</span>
                        @endif
                    </label>
                </div>
                @endforeach
