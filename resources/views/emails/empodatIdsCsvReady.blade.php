...
<head>
  ...
  <title>Your IDs CSV Export Is Ready</title>
</head>
<body style="margin: 0; padding: 0; background-color: #f6f6f6; font-family: Arial, sans-serif;">
  ...
  <div style="max-width: 600px; margin: 40px auto; background-color: #ffffff; padding: 20px; border-radius: 6px; color: #333; line-height: 1.6;">
    ...
    <p style="margin-bottom: 16px;">
      We encountered an error while processing your IDs export request:
    </p>
    ...
    <h2 style="margin-top: 0; margin-bottom: 16px; font-weight: normal;">
      Your IDs CSV Export Is Ready!
    </h2>

    <!-- Intro Paragraph -->
    <p style="margin-bottom: 16px;">
      Your requested Empodat IDs export for R is now available.
    ...
    <div style="background-color: #e9f7f6; padding: 15px; border-radius: 4px; margin-bottom: 20px;">
      ...
      <p style="margin: 0 0 8px 0;"><strong>IDs:</strong> {{ number_format($messageContent['total_records']) }}</p>
      @endif
    ...
    <!-- Usage Note -->
    <div style="background-color: #fff3cd; border-left: 4px solid #ffc107; padding: 12px; margin-bottom: 16px;">
      <p style="margin: 0; color: #856404;">
        <strong>Note:</strong> This CSV file contains only the Empodat record IDs, one per line, suitable for use in R scripts.
      </p>
    </div>
