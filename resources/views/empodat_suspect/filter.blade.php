<x-app-layout>
  ...
  <div class="py-4">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg rounded-0">
        ...
        <!-- Main Search form -->
        <form x-data="empodatSuspectSearchForm()"
              @submit="submitForm($event)"
              name="searchEmpodatSuspect"
              id="searchEmpodatSuspect"
              action="{{route('empodat_suspect.search.search')}}"
              method="GET"
              role="search"
              aria-label="EMPODAT Suspect Database Search Form">
          ...
          <div x-show="loading"
              ...
              <div class="text-center p-6 sm:p-8 bg-white rounded-lg shadow-xl max-w-sm sm:max-w-md w-full mx-4">
                  <h2 id="loading-title" class="text-xl font-bold text-slate-700 mb-2">EMPODAT Suspect Search</h2>
          ...
          <div class="p-4 text-gray-900 grid grid-cols-1 gap-4">
            ...
            <div class="flex flex-col sm:flex-row justify-end m-2 gap-2">
              <a href="{{route('empodat_suspect.search.filter')}}" class="btn-clear mx-2 text-center"> Reset </a>
  ...
  <script>
    function empodatSuspectSearchForm() {
      return {
        loading: false,
        seconds: 0,
        timerInterval: null,
