  ...
  <div class="py-4">
    <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
      <div class="bg-white overflow-hidden shadow-lg rounded-0">
        ...
        <form name="searchEmpodatSuspect" id="searchEmpodatSuspect" action="{{route('empodat_suspect.search.search')}}" method="GET">
          ...
          <div class="p-4 text-gray-900 grid grid-cols-1 gap-4">
                  ...
                  <div class="w-full">
                    ...
                    <div>
                      @include('_t.form-apline-multiselect', [
                        'tag' => 'stationSearch',
                        'list' => $stationList,
                        'active_ids' => isset($request->stationSearch) ? $request->stationSearch : [],
                      ])
                    </div>
                  </div>
                </div>
            ...
            <div id="searchSubstance">
              <div class="bg-gray-100 p-2">
                ...
                <div>
                  @livewire('empodat-suspect.substance-search', ['existingSubstances' => $request->substances ?? []])
                </div>
              </div>
            </div>
            ...
            <div class="flex justify-end m-2">
              <a href="{{route('empodat_suspect.search.filter')}}" class="btn-clear mx-2"> Reset </a>
