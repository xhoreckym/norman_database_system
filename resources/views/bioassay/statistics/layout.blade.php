        ...
        <div class="p-6 text-gray-900">
          ...
          <div class="mb-6">
            <h2 class="text-3xl font-bold text-gray-800 mb-4">
              @yield('page-title', 'Bioassay Statistics')
            </h2>
              ...
              <div class="mb-6">
                <div class="bg-amber-50 border border-amber-600 rounded-lg p-4">
                  ...
                  <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
                    <form action="{{ route('bioassay.statistics.generate') }}" method="POST">
                      @csrf
                      <button type="submit"
                  ...
                  <div class="mt-3 text-sm text-amber-700">
                    <strong>Note:</strong> This will generate statistics for countries, bioassay names, endpoints, determinands, and years.
                  </div>
                </div>
              </div>
            @endif
